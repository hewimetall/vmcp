...
**Язык:** [English](../deployment.md) | Русский
...
Манифесты Gateway API + PVC + probes: [`deploy/k8s/`](../../deploy/k8s/).<br>
...
Детали: [upstreams.md](upstreams.md), [skills.md](skills.md), [demo/README.ru.md](../../demo/README.ru.md).
...
- [ ] Проверен prod `registry.json` (локальный стенд — [`demo/README.ru.md`](../../demo/README.ru.md) / [`demo/vmcp.toml`](../../demo/vmcp.toml))
