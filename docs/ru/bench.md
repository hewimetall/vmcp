...
Поставляемые адаптации (см. [`bench/prompts/SOURCES.ru.md`](../../bench/prompts/SOURCES.ru.md)):
...
См. [`bench/README.ru.md`](../../bench/README.ru.md) для карты каталогов, определения метрики
и известных ограничений. Исторические числа A vs C (1400 runs) лежат в
[`bench/RESULTS.ru.md`](../../bench/RESULTS.ru.md).
