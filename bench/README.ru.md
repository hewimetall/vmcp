...
**Операторское руководство:** [`docs/ru/bench.md`](../docs/ru/bench.md)
...
Источники и заметки об адаптации: [`prompts/SOURCES.ru.md`](prompts/SOURCES.ru.md).
Полное операторское руководство: [`docs/ru/bench.md`](../docs/ru/bench.md).
