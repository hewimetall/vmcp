...
| [clients.md](clients.md) | Скриптовые MCP/HTTP-клиенты и vmcp-lite для локального stdio host |
| [how-to/connect-cursor.md](how-to/connect-cursor.md) | Как подключить Cursor к vmcp |
| [how-to/connect-opencode.md](how-to/connect-opencode.md) | Как подключить OpenCode к vmcp |
| [how-to/connect-agno.md](how-to/connect-agno.md) | Как подключить агента Agno к vmcp |
...
- Демо: [`demo/README.ru.md`](../../demo/README.ru.md) + [`demo/vmcp.toml`](../../demo/vmcp.toml)
